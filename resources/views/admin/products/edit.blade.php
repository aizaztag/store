...
@section('styles')
<link rel="stylesheet" type="text/css" href="{{ asset('backend/css/plugins/dropzone/dist/min/dropzone.min.css') }}"/>
@endsection
@section('content')
    <div class="app-title">
        <div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select name="categories[]" id="categories" class="form-control" multiple style="width: 100%">
