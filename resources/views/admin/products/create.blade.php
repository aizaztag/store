...
@push('scripts')
    ...
    <script>
        ...
        var sale_priceDOM = document.getElementById("sale_price");
        var para = '';//document.createElement("p");
        function blr(){
            var price = priceDOM.value;
            var sale_price = sale_priceDOM.value;
            if(price === "" && sale_price === ""){
                para = "Please enter value in both.";
                alert(para);
            }
            else if(sale_price >= price){
                para = "Value present in sale price input is greater then sale.";
                alert(para);
                sale_priceDOM.value ='';
            }
        }
        ...
        function blrPrice(){
            if(this.value !== '') sale_priceDOM.disabled = false;
            else sale_priceDOM.disabled = true;
        }
        //sale_priceDOM.addEventListener("blur",blr);
        //priceDOM.addEventListener("blur",blrPrice);
        /*price and sale price validation*/
